...
export const INITIAL_USERS: UserAccount[] = [
  {
    ...
    permissions: [
      ...
      'comercial.dashboard.visualizar', 'comercial.pedidos.visualizar', 'comercial.pedidos.detalhes', 'comercial.pedidos.exportar', 'comercial.vendas.visualizar', 'comercial.vendas.valores.visualizar', 'comercial.vendas.performance.visualizar', 'comercial.vendas.exportar',
      'comercial.produtores.visualizar', 'comercial.produtores.criar', 'comercial.produtores.editar', 'comercial.produtores.detalhes',
      'comercial.carteira.visualizar', 'comercial.carteira.atribuir',
      'comercial.prospeccoes.visualizar', 'comercial.prospeccoes.criar', 'comercial.prospeccoes.editar', 'comercial.prospeccoes.converter',
      'comercial.oportunidades.visualizar', 'comercial.oportunidades.criar', 'comercial.oportunidades.editar', 'comercial.oportunidades.mover', 'comercial.oportunidades.ganhar', 'comercial.oportunidades.encerrar',
      'comercial.pipeline.visualizar', 'comercial.pipeline.configurar', 'comercial.propostas.gerenciar', 'comercial.metas.visualizar',
      'comercial.atividades.visualizar', 'comercial.atividades.registrar',
      'tarefas.central.visualizar', 'tarefas.tarefa.visualizar', 'tarefas.tarefa.criar', 'tarefas.tarefa.editar',
