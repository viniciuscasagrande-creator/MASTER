      ...
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A] shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/60 px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-white">Lavrar Aditivo Contratual (Amendment)</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Alteração formal e versionada para o contrato <span className="font-mono font-semibold text-slate-900 dark:text-white">{contractCode}</span>
              </p>
            </div>
          </div>
          <button
            ...
            <div className="space-y-3 border-t border-slate-100 dark:border-slate-800 pt-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg bg-slate-100 dark:bg-slate-800 px-2.5 py-1 text-[11px] font-semibold text-orange-600 dark:text-orange-400 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 transition-colors"
                >
              ...
              <div className="space-y-2">
                {terms.map((term, index) => (
                  <div
                    key={index}
                    className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/40 p-3.5 grid grid-cols-1 md:grid-cols-4 gap-2 text-xs"
                  >
                    <div>
                    ...
                    <div>
                      <label className="block text-[10px] font-medium text-slate-500 dark:text-slate-400">Descrição</label>
                      <input
                        type="text"
                        value={term.name}
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      {terms.length > 1 && (
                        <button
                          ...
                          className="text-slate-400 hover:text-rose-500 p-1.5 mb-0.5 transition-colors"
                        >
