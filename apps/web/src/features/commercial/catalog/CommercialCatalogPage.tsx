  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-lg">
        ...
        {/* Filters Bar */}
        <div className="p-4 border-b border-slate-800 bg-slate-950/40 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-800 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-indigo-500"
            />
          </div>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="font-mono text-[11px] text-indigo-400 font-semibold group-hover:underline">
                          {off.publicCode}
                        </span>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {off.status === 'ACTIVE' && (
                          <Button
                            ...
                            className="h-8 px-2 text-slate-400 hover:text-amber-400 hover:bg-amber-500/10"
