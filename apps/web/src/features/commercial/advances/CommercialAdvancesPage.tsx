    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Operações solicitadas no período</p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Recursos efetivamente liberados</p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Taxa de antecipação Disk</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 shadow-lg overflow-hidden">
        <div className="p-4 border-b border-slate-800 flex items-center justify-between">
          <div className="text-xs text-slate-400">
            Mostrando <strong className="text-white font-mono">{advances.length}</strong> operação(ões) de antecipação
          </div>
        </div>
              ...
              {advances.map((adv) => (
                <tr key={adv.id} className="hover:bg-slate-800/40 transition-colors">
                  <td className="py-3 px-4">
                    <strong className="text-white font-mono">{adv.code}</strong>
                  </td>
                  <td className="py-3 px-4">
                    <div>
                      <strong className="text-slate-200 block">{adv.eventTitle}</strong>
                      <span className="text-[11px] text-slate-400">{adv.producerName}</span>
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-4">
                    <span className="text-orange-400 font-mono">{(adv.advanceRateBps / 100).toFixed(1)}%</span>
                    <span className="text-[10px] text-slate-500 block">({formatCurrency(adv.costCents / 100)})</span>
                  </td>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden text-slate-100">
            <div className="bg-slate-950 px-6 py-4 flex items-center justify-between border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-white">Nova Solicitação de Antecipação</h3>
              </div>
