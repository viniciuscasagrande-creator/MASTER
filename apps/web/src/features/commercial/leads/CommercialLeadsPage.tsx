                      ...
                      <td className="px-4 py-3.5">
                        {lead.contactName ? (
                          <div>
                            ...
                            <div className="text-[10px] text-slate-400">{lead.contactRole || 'Contato'}</div>
                            {lead.contactEmail && (
      ...
      <Modal
        ...
        title={
          <div className="flex items-center gap-2">
            ...
            <span>Cadastrar Nova Prospecção (Lead)</span>
          </div>
        }
        size="lg"
      >
      ...
      <Modal
        ...
        title={
          <div className="flex items-center gap-2">
            ...
            <span>Converter Prospecção em Produtor Credenciado</span>
          </div>
        }
        size="md"
      >
        <div className="space-y-4">
          ...
          <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-2 text-xs">
            ...
            <ul className="space-y-1.5 text-slate-400 list-disc list-inside">
              <li>Criação da entidade mestre <strong className="text-slate-200">Produtor</strong> no Core</li>
              <li>Criação da <strong className="text-slate-200">Conta Comercial</strong> com parâmetros acordados</li>
              <li>Vinculação na sua <strong className="text-slate-200">Carteira Comercial</strong> como Owner</li>
