  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-9 py-2 text-xs rounded-xl bg-slate-900/90 border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-orange-500/60 focus:ring-1 focus:ring-orange-500/40 transition-colors"
          />
          {filters.search && (
            <button
      ...
      <div className="flex items-center justify-between text-xs text-slate-400 px-1">
        <div>
          Exibindo <span className="font-semibold text-white">{totalResults}</span> {totalResults === 1 ? 'evento' : 'eventos'}
        </div>
